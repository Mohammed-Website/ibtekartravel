        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/ibtekartravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.jpg">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض المالديف',
        image_1: ['مكتب-سياحي-سعودي/عروض-المالديف/عرض-المالديف-1.jpg', 'عرض المالديف - 5 أيام'],
        image_2: ['مكتب-سياحي-سعودي/عروض-المالديف/عرض-المالديف-2.jpg', 'عرض المالديف - 4 أيام'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['مكتب-سياحي-سعودي/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'كوالا & لينكاوي & بينينج & سيلانجور'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['مكتب-سياحي-سعودي/عروض-جورجيا/عرض-جورجيا-1.jpg', 'عرض جورجيا - 8 أيام'],
    },

    {
        title: 'عروض اليونان',
        image_1: ['مكتب-سياحي-سعودي/عروض-اليونان/عرض-اليونان-1.jpg', 'أثينا & ميكونوس & سانتوريني'],
        image_2: ['مكتب-سياحي-سعودي/عروض-اليونان/عرض-اليونان-2.jpg', 'عرض اليونان - 8 أيام'],
    },

    {
        title: 'عروض اوكرانيا',
        image_1: ['مكتب-سياحي-سعودي/عروض-اوكرانيا/عرض-اوكرانيا-1.jpg', 'عرض اوكرانيا - كييف'],
        image_2: ['مكتب-سياحي-سعودي/عروض-اوكرانيا/عرض-اوكرانيا-2.jpg', 'كييف & لفيف & بوكوفيل'],
        image_3: ['مكتب-سياحي-سعودي/عروض-اوكرانيا/عرض-اوكرانيا-3.jpg', 'عرض اوكرانيا - 8 أيام'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['مكتب-سياحي-سعودي/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - 7 أيام'],
    },

    {
        title: 'عروض موريشيوس',
        image_1: ['مكتب-سياحي-سعودي/عروض-موريشيوس/عرض-موريشيوس-1.jpg', 'عرض شهر عسل - 6 أيام'],
        image_2: ['مكتب-سياحي-سعودي/عروض-موريشيوس/عرض-موريشيوس-2.jpg', 'عرض يوم كامل في وادي الالوان'],
    },

    {
        title: 'عروض اسبانيا',
        image_1: ['مكتب-سياحي-سعودي/عروض-اسبانيا/عرض-اسبانيا-1.jpg', 'عرض اسبانيا - 6 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966551243752?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/seeftravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا ابتكار على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة ابتكار على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة ابتكار على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا شركة ابتكار للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة ابتكار للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة ابتكار`;
            img.title = `مكتب سياحي - شركة ابتكار`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966551243752";
